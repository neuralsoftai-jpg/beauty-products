...
const testimonials = [
  ...
  },
  {
    ...
    rating: 5,
    text: "Finally, skincare that actually feels natural. No more harsh chemicals. My sensitive skin loves Elysian products.",
  ...
  },
  {
    ...
    location: "Miami",
    rating: 5,
    text: "I've tried countless serums but nothing compares to the glow I get from Elysian. Absolutely transformative.",
    product: "Glow Serum"
  },
  {
    id: 5,
  ...
  },
  {
    ...
    location: "Boston",
    rating: 5,
    text: "My acne-prone skin has cleared up since switching to Elysian. Natural ingredients really make a difference.",
    product: "Gentle Cleanser"
  },
  {
    id: 7,
  ...
  },
  {
    ...
    location: "Portland",
    rating: 5,
    text: "I love that Elysian is cruelty-free and vegan. Great products that align with my values.",
    product: "Hydra Cream"
  },
  {
    id: 9,
